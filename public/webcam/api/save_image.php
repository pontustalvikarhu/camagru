...
//$folder = "C:/wamp64/www/camagru/uploads/images/";
$folder = "C:/wamp64/www/git_camagru/public/img/";
$destinationFolder = /*$_SERVER['C:\wamp64\www\camagru\api'] . */$folder;
...
if(!$success)
	exit(json_encode(['success' => false, 'reason' => 'the server failed to creating image']));

// Inform the browser about the path to the newly created image
exit(json_encode(['success' => true, 'path' => "$filename"]));
?>