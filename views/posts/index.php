...
<?php require APPROOT . '/views/inc/header.php';?>
	...
	<div class="card card-body mb-3">
		...
		<div class="img_container">
			<img src="<?php echo $post->img; ?>" title="image" alt="image">
		</div>
	...
	<?php if (isset($_SESSION['user_id']) && $_SESSION['user_id'] != 'guest') : ?>
		...
		<form action="<?php echo URLROOT; ?>/posts/<?php if ($user_liked === 0) : echo "like"; endif; if ($user_liked === 1) : echo "unlike"; endif; ?>/<?php echo $post->postId; ?>" method="post">
			<input type="hidden" name="csrf-token" id="csrf-token" value="<?php echo $_SESSION['token']?>">
			<input type="submit" class="btn btn-success" value="<?php if ($user_liked === 0) : echo "Like"; endif; if ($user_liked === 1) : echo "Unlike"; endif; ?>">
		</form>
