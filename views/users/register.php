      ...
      <div class="card card-body bg-light mt-5">
        ...
        <form action="<?php echo URLROOT; ?>/users/register" method="post">
		  ...
		  <div class="form-group">
            ...
            <input type="text" name="username" class="form-control form-control-lg <?php echo (!empty($data['username_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['username']; ?>" autocomplete="on">
          ...
          <div class="form-group">
            ...
            <input type="password" name="confirm_password" class="form-control form-control-lg <?php echo (!empty($data['confirm_password_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['confirm_password']; ?>" autocomplete="new-password">
